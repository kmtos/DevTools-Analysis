...
class Hpp4lAnalysis(AnalysisBase):
    ...
    def __init__(self,**kwargs):
        ...
        self.addLepton('hmm1',doId=True,doScales=True,doFakes=True,doErrors=True)
        self.addLepton('hmm2',doId=True,doScales=True,doFakes=True,doErrors=True)
        self.addJet('hmm1jet')
        self.addJet('hmm2jet')
    ...
    def selectCandidates(self):
        candidate = {
            ...
            'hmm1jet' : Candidate(None),
            'hmm2jet' : Candidate(None),
            'hpp' : None,
            'hppmet' : None,
            'hmm' : None,
            'hmmmet' : None,
...
def parse_command_line(argv):
    ...
    parser.add_argument('--inputFiles', type=str, nargs='*', default=getTestFiles('hpp',version='80XHpp'), help='Input files')
